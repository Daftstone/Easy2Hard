...
def run_threshold_experiment(data, criterion_fn, name, load_path):
    ...
    # x_train = np.load(
    #     "datasets/embedding/x_train_%s_%s_%s_%d_%d.npy" % (args.dataset, args.detectLLM, args.method, args.sentence_length, args.iter))
    # y_train = np.load(
    #     "datasets/embedding/y_train_%s_%s_%s_%d_%d.npy" % (args.dataset, args.detectLLM, args.method, args.sentence_length, args.iter))
    # x_test = np.load(
    #     "datasets/embedding/x_test_%s_%s_%s_%d_%d.npy" % (args.dataset, args.detectLLM, args.method, args.sentence_length, args.iter))
    # y_test = np.load(
    #     "datasets/embedding/y_test_%s_%s_%s_%d_%d.npy" % (args.dataset, args.detectLLM, args.method, args.sentence_length, args.iter))
